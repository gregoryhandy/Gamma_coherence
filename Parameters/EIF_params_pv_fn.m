%%
% Adj parameters used in Veit et al., where VIP inhibits PV neurons
%
% Inputs:
...
%%
function [params] = EIF_params_pv_fn(surround_diff,contrast,light,stim_size)
...
params.mu_bg = repmat([3 3 5.25],1,params.Npop/3);
...
params.N_vip = repmat([0,500,0],1,params.Npop/3);
