%%
% Default parameters used in Veit et al.
%
% Inputs:
...
%%
function [params] = EIF_params_official_fn_Nlim(surround_diff,contrast,light,stim_size,Ntot)
...
params.Ncells = repmat([0.8*Ntot, 0.1*Ntot, 0.1*Ntot]',params.Npop/3,1);
...
params.N_vip = repmat([0,0,Ntot*0.1],1,params.Npop/3);
