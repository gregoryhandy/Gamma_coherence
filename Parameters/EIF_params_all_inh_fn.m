%%
% Adj. parameters used in Veit et al. where VIP inhibits all cell types
%
% Inputs:
...
%%
function [params] = EIF_params_all_inh_fn(surround_diff,contrast,light,stim_size)
...
params.N_vip = repmat([500,500,500],1,params.Npop/3);
